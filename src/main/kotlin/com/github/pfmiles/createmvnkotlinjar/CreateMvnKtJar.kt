...
class CreateMvnKtJar {
    companion object {
        ...
        fun main(args: Array<String>) {
            if (args.size < 2) {
                println("usage: CreateMvnKtJar groupId artifactId kotlinVersion(optional) javaVersion(optional) mainClsName(optional)")
                System.exit(1)
            }
            ...
            val mainClsName = args.getOrElse(4) { "com.github.pfmiles.Hello" }
            ...
            File("./pom.xml").bufferedWriter(Charsets.UTF_8).write(
                """
